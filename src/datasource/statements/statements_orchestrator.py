from datasource.statements.statements_processor import StatementsProcessor
...
class StatementsOrchestrator(DataOrchestrator):
    ...
    def __init__(self, data_source, es_host, kb_index, use_saved_reducer=False, use_saved_clusterer=False):
        ...
        self.curation_index_id = get_statement_recommendation_index_id(kb_index)
    ...
    def orchestrate(self):
        ...
        processor = StatementsProcessor(self.data_source, reducer, clusterer, embedder)
