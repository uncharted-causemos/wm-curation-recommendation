...
class DistanceMetrics:
    ...
    @classmethod
    def kl_divergence(cls, doc, data, num_recommendations):
        concepts = cls._get_all_concepts_in_candidates(data)
        concept_candidate_distributions = np.array(list(map(cls._map_concept_candidates_to_distribution(concepts), data)))

        # Get kl divergence scores
        doc_concept_candidate_dist = np.array(cls._map_concept_candidates_to_distribution(concepts)(doc))
    ...
    @classmethod
    def _get_all_concepts_in_candidates(cls, factor_docs):
    ...
    @classmethod
    def _map_concept_candidates_to_distribution(cls, concepts):
